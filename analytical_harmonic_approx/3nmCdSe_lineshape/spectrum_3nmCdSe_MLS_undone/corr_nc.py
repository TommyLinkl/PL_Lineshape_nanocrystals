...
fig.suptitle(r"Absorption spectra for the MLS, E17 model, 3nmCdSe at T=1")
...
for exc in range(nExc):
    ...
    # plotting
    axs[0].set(xlabel="Energey [meV]", title="Spectra", xlim=(1500, 3500))
    axs[0].plot(this_exc_spectrum_w_E17, this_exc_spectrum_I_E17, label="exciton #%d" % exc)
    axs[0].legend()

axs[1].set(xlabel="Energey [meV]", title="Spectra", xlim=(1500, 3500))
axs[1].plot(this_exc_spectrum_w_E17, total_spectrum, label="Total spectra")
axs[1].legend()
