...
domega = 0.1e-3                                    # in eV
omega_range = np.arange(1., 3., domega)                # in eV
...
(spectrum_w_E17_cutoff1, spectrum_I_E17_cutoff1) = spectrum(delta_E_E17, t_range, F_t_Re_E17_erf_1, F_t_Im_E17_erf_1, omega_range)
(spectrum_w_E17_cutoff2, spectrum_I_E17_cutoff2) = spectrum(delta_E_E17, t_range, F_t_Re_E17_erf_2, F_t_Im_E17_erf_2, omega_range)
(spectrum_w_E17_cutoff3, spectrum_I_E17_cutoff3) = spectrum(delta_E_E17, t_range, F_t_Re_E17_erf_3, F_t_Im_E17_erf_3, omega_range)
...
(FWHM_cutoff1, l_index_1, r_index_1) = calc_FWHM(spectrum_w_E17_cutoff1, spectrum_I_E17_cutoff1)
write_FWHM("FWHM_cutoff1.dat", spectrum_w_E17_cutoff1, spectrum_I_E17_cutoff1, l_index_1, r_index_1)
(FWHM_cutoff2, l_index_2, r_index_2) = calc_FWHM(spectrum_w_E17_cutoff2, spectrum_I_E17_cutoff2)
write_FWHM("FWHM_cutoff2.dat", spectrum_w_E17_cutoff2, spectrum_I_E17_cutoff2, l_index_2, r_index_2)
(FWHM_cutoff3, l_index_3, r_index_3) = calc_FWHM(spectrum_w_E17_cutoff3, spectrum_I_E17_cutoff3)
write_FWHM("FWHM_cutoff3.dat", spectrum_w_E17_cutoff3, spectrum_I_E17_cutoff3, l_index_3, r_index_3)
