...
axs[0].plot(4150-x3, y3, ":b", linewidth=1, label="Meijerink JPCC")
axs[0].set(xlim=(1900,2250), ylim=(0, 1), xlabel="Energy [meV]", ylabel="Abs", title="3nmCdSe/2MLCdS QD ensemble line shape at low T (5K)")
