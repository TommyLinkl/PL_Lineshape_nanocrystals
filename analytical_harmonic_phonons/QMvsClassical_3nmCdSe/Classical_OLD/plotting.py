...
for i in range(len(T_range)): 
    ...
    axs[i,2].plot(E_range, I_E_range, label="Classical")
    axs[i,2].plot(E_range, I_Gaussian, label="Static limit")
    axs[i,2].grid()
    axs[i,2].legend()
    axs[i,2].set(xlabel=r"Energy [eV]", ylabel=r"$I(\omega)$", xlim=[2.1,2.3])
...
fig.tight_layout()
fig.savefig("Static_limit_v_Classical.png")
