...
def J(omega):
    return 2 / PI * omega**(-3) * np.exp(-omega)
...
fig.suptitle("Convergence for MC's equivalent of SK's Sub-Ohmic  \n")
...
for i in range(2):
    ...
    for N in np.array([1000, 5000, 10000]): 
        domega = 20. / N
...
fig.tight_layout()
fig.savefig("Skinner_SubOhmic.png")
